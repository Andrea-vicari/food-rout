...
var SINGLE_REC_URL = 'https://www.themealdb.com/api/json/v1/1/lookup.php?i='.concat(trimmedURL);
...
const SingleRecipe = () => {
  ...
  <div className="col-10 col-sm-8 col-lg-6">
    <img src={objClone.strMealThumb} className="d-block mx-lg-auto img-fluid" alt=".." width="700" loading="lazy"/>
  </div>
